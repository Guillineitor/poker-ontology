...
foreach ($archivo in $archivos) {
    ...
    if ($codigoSalida -ne 0) {
        Write-Warning "  generador_instancias.py devolvio codigo $codigoSalida para $($archivo.Name)."
        $fallidos++
